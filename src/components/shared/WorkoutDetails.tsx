...
const WorkoutDetails: React.FC<WorkoutDetailsProps> = ({ workout }) => {
  return (
    <div className="min-h-screen bg-[#0b0d12] px-3 py-10 text-white sm:px-5 lg:px-8">
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-8 rounded-3xl border border-gray-800 bg-[#0d0f17] p-4 sm:p-6 lg:grid-cols-2">
        {/* Image */}
        <div className="relative h-[350px] w-full overflow-hidden rounded-2xl sm:h-[450px] lg:h-[400px]">
          <Image
            src={workout.image}
            alt={workout.name}
            fill
        ...
        <div className="flex flex-col justify-between">
          <div>
            {/* Title */}
            <h1 className="mb-3 text-3xl font-black uppercase tracking-wide sm:text-4xl">
              {workout.name}
            </h1>
            ...
            {/* Workout Stats */}
            <div className="mb-6 space-y-4 rounded-2xl border border-gray-800/80 bg-[#12141c] p-5">
              {/* Equipment */}
          ...
          <div className="flex flex-col gap-3 pt-2 sm:flex-row">
            <button
              type="button"
              className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#ccff00] px-5 py-3 font-bold uppercase text-black transition hover:bg-[#b8eb00]"
            >
            ...
            <button
              type="button"
              className="flex items-center justify-center gap-2 rounded-xl bg-[#171a23] px-5 py-3 font-bold uppercase text-white transition hover:bg-[#20242f]"
            >
